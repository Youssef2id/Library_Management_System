...
<!--===============================================================================================-->
  ...
  <body>
    <div class="s003">
      <form action="/Project_2019/borrow/borrow_page_2.jsp">
        <div class="inner-form">
          <div class="input-field second-wrap">
            <input id="search" type="number" min="0" placeholder="Book Id" name="search"/>
          </div>
...
<%
	...
	{
		b = Book.recupererTout(Integer.parseInt(request.getParameter("search")));
		if (b.length == 0)
			out.println("Book NOT FOUND");
	}
	else
		b = Borrowed.borrowed_books(Student.get_student_id(cin));
	int i = 0;
							...
							<tbody>
								<tr class="row100 body">
									...
									<td class="cell100 column7">
										<form class="login100-form validate-form" action="/Project_2019/return/submit_return.jsp">
											<div class="container-login100-form-btn1">
											<input type="hidden" name="cin" value="<%=cin%>">
												<button name="book_id" class="login100-form-btn" type="submit" value="<%=b[i].getId()%>">
													Select
												</button>
											</div>
										</form>
